...
impl Text {
    ...
    pub fn line_len(&self, row: u32) -> u32 {
        ...
        line_len.saturating_sub(prefix_len).saturating_sub(suffix_len) as u32
    }
    ...
    pub fn point_for_offset(&self, offset: usize) -> Point {
        self.abs_point_for_offset(self.range.start + offset) - &self.abs_point_for_offset(self.range.start)
    }
    ...
    pub fn summary(&self) -> TextSummary {
        TextSummary {
            ...
            bytes: self.abs_byte_offset_for_offset(self.range.end) - self.abs_byte_offset_for_offset(self.range.start),
            lines: self.abs_point_for_offset(self.range.end) - &self.abs_point_for_offset(self.range.start),
