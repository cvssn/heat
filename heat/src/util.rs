    ...
    F: FnMut(&'a T) -> Result<Ordering, E>
{
    ...
    while size > 1 {
        ...
        // mid está sempre em [0, tamanho), o que significa que mid é >= 0 e < size
        // mid >= 0: por definição
        // mid < tamanho: mid = tamanho / 2 + tamanho / 4 + tamanho / 8 ...
    ...
    // base está sempre em [0, tamanho) porque a base <= mid
