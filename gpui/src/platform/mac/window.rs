...
impl Window {
    pub fn open(
        ...
        unsafe {
            ...
            let device = metal::Device::system_default().ok_or_else(|| anyhow!("não foi possível encontrar o dispositivo de metal padrão"))?;
...
impl platform::WindowContext for WindowStat {
    fn size(&self) -> Vector2F {
...
extern "C" fn view_did_change_backing_properties(this: &Object, _: Sel) {
    ...
    unsafe {
        let _: () = msg_send![window_state.layer, setContentsScale: window_state.scale_factor() as f64];
    }
